...
7. Copilot Studio로 돌아와서 **SAP Product Data Update** 토픽의 복사본을 만들고, 토픽명과 토픽이 수행할 작업에 대한 지침을 전달합니다.</br></br>
   **토픽명**
   ```
...
13. 조건 반대편 **기타 모든 조건** 아래의 노드를 전부 삭제하고, **SAP Product Data Read** 토픽을 호출합니다.
